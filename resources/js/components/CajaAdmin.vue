...
<main>
                    ...
                    <div class="row ">
                        ...
                        <template v-for="(caj,index) in cajasAperturadas" >
                            ...
                            <div class="col-lg-4" :key="caj.id"> 
                                ...
                                <button class="btn btn-primary" @click="verdetalleCaja(caj.id)">Detalle de Caja</button>
    ...
    <template v-if="verdetallecaja==true">
                        ...
                        <div class="col-lg-8 ">
                         ...
                         <div class="col-lg-4 ">
                            <h3 class="font-weight-bold text-dark ">
                                ...
                                <template>
                                    <button type="button" @click="TodasCajas(arrayCaja[0].id)" class="btn btn-danger">Ver todas las Cajas</button>
        ...
        datosactuales(){
         ...
         MovimientosCaja (id){
               ...
               // if(me.idcajaactual!=0){
                   me.totaldinero=0;
                var url= me.ruta+'/caja/MovimientosCaja?id='+id;
            ...
            TodasCajas(id){
                 let me=this;
                me.verdetallecaja=false;
                 me.sumaaportes=0,
                 

                me.sumapagos=0,
                me.sumamovimiento=0,
                me.restamovimiento=0,
                me.sumadesembolso=0,

                me.arrayMovimientos.length=0,
                me.arrayCaja.length=0,
                me.arrayTabla.length=0,
                me.estadoMovimiento=0,
                me.totalTabla=0
